...
-(JSCollectionViewController *)collectionViewController{
    if (_collectionViewController==nil) {
        _collectionViewController=[[JSCollectionViewController alloc] initWithState:JSCollectionViewNormal CollectionViewCellClass:[JSProductCollectionCell class] delegate:self];
...
#pragma mark -4:左上角折扣/价格
            ...
            JSProductCollectionCellModelFrame *frameModel=[[JSProductCollectionCellModelFrame alloc] initWithModel:model];
