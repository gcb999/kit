//
//  JSProductBasisCollectionCellModelFrame.h
//  kit
//
...
#import "JSProductBasisCollectionCellModel.h"

@interface JSProductBasisCollectionCellModelFrame : NSObject
...
#pragma mark -实体
@property(nonatomic,strong)JSProductBasisCollectionCellModel *baseModel;


-(instancetype)initWithModel:(JSProductBasisCollectionCellModel *)model;
