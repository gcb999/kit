//
//  PlaceOrderCollectionCellModelFrame.m
//  kit
//
...
#import "JSPlaceOrderCollectionCellModelFrame.h"

@implementation JSPlaceOrderCollectionCellModelFrame
...
-(instancetype)initWithModel:(JSPlaceOrderCollectionCellModel *)model{
    if (self=[super initWithModel:model]) {
        ...
        self.model=model;
        [self layoutSubFrame:CGRectMake(0, 0, IPHONScreenWidth, 1000000)];
